 ...
 */
public class IfDetect extends Detector<CtIf> {
    ...
    public void collectInjectors(AbstractMap<String, Collection<Injector>> injectors) {
        ...
        elseBeginInjectors = injectors.containsKey(ELSE_BEGIN_KEY) ? injectors.get(ELSE_BEGIN_KEY) : new ArrayList<>();
        elseEndInjectors = injectors.containsKey(ELSE_END_KEY) ? injectors.get(ELSE_END_KEY) : new ArrayList<>();
    }
