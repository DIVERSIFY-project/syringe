 ...
 */
public class GetInjectionWithIdTest extends InstrumentationTest {
    ...
    public void defaultMethodBeginTest() throws Exception {
        ...
        String injection = TestLogger.class.getCanonicalName() + ".testWithId";
        conf.addInjector(MethodDetect.getEventName(), new GenericInjectWithId(injection));
