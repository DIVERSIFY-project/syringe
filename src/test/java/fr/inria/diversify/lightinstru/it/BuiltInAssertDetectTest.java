...
import fr.inria.diversify.lightinstru.detectors.BuiltInAssertDetector;
 ...
 */
public class BuiltInAssertDetectTest extends InstrumentationTest {

    private static final String OUT_FOLDER = "out";

    @Test
    public void builtInDetectTests() throws Exception {
        ...
        conf.addDetector(new BuiltInAssertDetector());
        ...
        conf.addInjector(BuiltInAssertDetector.END_KEY, new GenericInjector(injection));
