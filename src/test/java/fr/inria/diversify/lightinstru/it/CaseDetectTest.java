 ...
 */
public class CaseDetectTest extends InstrumentationTest {
    ...
    @Test
    public void defaultCaseBeginTest() throws Exception {
        ...
        conf.addInjector(CaseDetect.BEGIN_KEY, new GenericInjector(injection));
        injection = TestLogger.class.getCanonicalName() + ".end();";
        conf.addInjector(CaseDetect.END_KEY, new GenericInjector(injection));
